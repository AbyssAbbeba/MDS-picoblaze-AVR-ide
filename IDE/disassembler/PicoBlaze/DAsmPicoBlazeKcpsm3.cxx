...
void DAsmPicoBlazeKcpsm3::reg ( std::string & line,
                                unsigned int addr )
{
...
void DAsmPicoBlazeKcpsm3::port ( std::string & line,
                                 unsigned int addr )
{
...
void DAsmPicoBlazeKcpsm3::data ( std::string & line,
                                 unsigned int addr )
{
...
void DAsmPicoBlazeKcpsm3::imm ( std::string & line,
                                unsigned int addr )
{
...
void DAsmPicoBlazeKcpsm3::label ( std::string & line,
                                  unsigned int addr,
                                  bool definition )
{
