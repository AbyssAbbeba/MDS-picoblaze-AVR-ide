...
int TestKcpsm1CPLD::init()
{
    ...
    m_disassembler = new DAsmPicoBlazeKcpsm1CPLD();
...
void TestKcpsm1CPLD::testFunction()
{
    ...
    m_options->m_sourceFiles.push_back( system_complete ( path("TestKcpsm1CPLD") / "testcases" / ( testName + ".asm" ) )
                                                        . string() );

    std::string resultsPath = system_complete( path("TestKcpsm1CPLD") / "results" / testName ).string();
