...
void TestKcpsm1::testFunction()
{
    ...
    const std::string inFile  = ( path("TestKcpsm1") / "testcases" / (testName + ".in" ) ).string();
    const std::string outFile = ( path("TestKcpsm1") / "results"   / (testName + ".out") ).string();
    const std::string hexFile = ( path("TestKcpsm1") / "results"   / (testName + ".hex") ).string();
