...
void TestKcpsm3::testFunction()
{
    ...
    create_directory ( path("TestKcpsm3") / "results" );

    std::string inFile  = ( path("TestKcpsm3") / "testcases" / (testName + "."   ) ).string();
    std::string outFile = ( path("TestKcpsm3") / "results"   / (testName + ".out") ).string();
    std::string hexFile = ( path("TestKcpsm3") / "results"   / (testName + ".hex") ).string();
