...
; parameter aloader AUTOREG directive. You can check assigned registers in codelisting (file .lst)
...
; incremented aloader each line by the number of bytes of data or code in that line.
