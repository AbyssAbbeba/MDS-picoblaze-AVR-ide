...
;
; PicoBlaze kod pro pocatecniÃÂ­ inicializaci A/D prevodniku ADS6445 a zdroje hodin LMK4011 + SPUÃ TÃÂNÃÂ TEST SEKVENCÃÂ

; A/D pÃÂevodnik - 16bit registry
;				  Max 20 MHz
;				  A4-A0 + D10-D0	
;
...
ret
					JUMP	Start
; ÃÂekÃÂ¡nÃÂ­ 1s pro inicializaci obvodÃÂ¯
