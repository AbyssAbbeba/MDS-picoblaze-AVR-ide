; ----------------------------------------------------------------------------------------------------------------------
; MDS for PicoBlaze - Demonstration code I: The First Steps
;
...
start:      load        S0, #11         ; Load register S0 with value 11 decimal.
            ...
            ; Something just to catch you eye... :-) we will talk about this in the next examples.
...
; * Please notice the speed of simulation in run mode, it's about 50..150 times slower than real time (proportional to
;   processor clock). For instance if you are simulation PicoBlaze running at 20MHz on a machine with 2GHz CPU, you
;   should get approximately real-time simulation. Not impressed? ... actually it's a pretty good performance, you can
;   rarely see simulators running with such efficient use of processing power, usually processor simulators run far
;   slower than that, even several thousand times slower ... really!
; ----------------------------------------------------------------------------------------------------------------------
; In the next example you will see how to use user defined constants and expressions, and what is the difference
; between operand prefixed with `#' or `@', and operand without any prefix.
; ----------------------------------------------------------------------------------------------------------------------
