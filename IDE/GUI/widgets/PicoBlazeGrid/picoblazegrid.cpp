    ...
    : QWidget(parent)
{
    ...
    this->leSP->setFont(QFont("Ubuntu Mono", 10));
    ...
    this->lePC->setFont(QFont("Ubuntu Mono", 10));
    ...
    this->leCycles->setFont(QFont("Ubuntu Mono", 10));
    ...
    this->leClock->setFont(QFont("Ubuntu Mono", 10));
