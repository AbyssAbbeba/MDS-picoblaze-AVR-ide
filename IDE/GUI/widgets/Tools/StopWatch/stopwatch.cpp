...
void StopWatch::saveAsText()
{
    ...
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs) << QString::number(core.structPtrStop->nanoSecs) << QString::number(core.structPtrStop->nanoSecs);
    out << "interurpz"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs) << QString::number(core.structPtrStop->nanoSecs) << QString::number(core.structPtrStop->nanoSecs);
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs);
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs);
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs);
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs);
    out << "Nano seconds"<< "\t" << "\t" << QString::number(core.structPtrStop->nanoSecs);
