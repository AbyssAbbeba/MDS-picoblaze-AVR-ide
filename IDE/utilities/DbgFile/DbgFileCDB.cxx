...
inline DbgFileCDB::Scope DbgFileCDB::parseScope ( char * & line,
                                                  int & fileNumber,
...
inline void DbgFileCDB::handleSymbolRecord ( char * line,
                                             SymbolRecord * target )
{
...
inline void DbgFileCDB::parseMemberSymbol ( char * typeMemberDef,
...
inline void DbgFileCDB::handleLinkerSymbolAddressRecord ( char * line,
                                                          bool startAddress )
{
    int address;
    int fileNumber = -1;
...
inline void DbgFileCDB::handleLinkerLineRecord ( char * line,
                                                 bool asmRecord )
{
    ...
    else if ( (unsigned int)(lineRecord.m_lineNumber) > m_numberOfLines[lineRecord.m_fileNumber] )
    {
...
inline char * DbgFileCDB::extractToken ( char * & line,
