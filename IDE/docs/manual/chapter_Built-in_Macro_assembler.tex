    ...
    \subsection{Program Control Group}
        \subsubsection{JUMP}
            ...
            \paragraph{Examples}
                ...
                \verb'my_label:'\\
                \verb'          ; ... code ...'\\
                \verb'          JUMP    my_label        ; Jump at my_label.'\\
                \verb''\\
                \verb'          JUMP    0x300 + 0xff    ; Jump at address 3FF hexadecimal.'

        \subsubsection{CALL}
            Call subprogram at the address specified by aaa operand.
            ...
            \paragraph{Examples}
                ...
                \verb''\\
                \verb'          CALL    40            ; Call subprogram at address 40 decimal.'
