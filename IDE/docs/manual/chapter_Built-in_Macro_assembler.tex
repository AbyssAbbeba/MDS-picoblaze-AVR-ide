...
\section{Assembler messages}
    ...
    \begin{description}
        ...
        \item[Character constant is too long]~\\
            Character constant is supposed to be one only letter long.
        ...
        \item[Directive `EXITM' cannot appear inside special macro (like run-time IF/ELSE, etc.), it would break its pairing rules]~\\
...
\section{Output files}
    ...
    \subsection{Specification of the Intel 8 HEX Format}
        ...
        \subsubsection{Example of an Intel 8 HEX code:}
