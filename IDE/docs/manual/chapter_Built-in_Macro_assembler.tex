...
\section{Assembler directives}
    ...
    \subsection{EQU}
        ...
        \subsubsection{Examples:}
            In this example, the assembler would always replace symbol}\verb'First_symb'} with 0x9C, symbol}\verb'Second_symb'} with 0x2F and symbol}\verb'Third_symb'} with 0x39.
        {
            ~\\
            \usecodefont
    ...
    \subsection{SET}
        ...
        \subsubsection{Examples:}
            In this example, the assembler would always replace symbol}\verb'First_symb'} with 0x9C, symbol}\verb'Second_symb'} with 0x2F and symbol}\verb'Third_symb'} with 0x39 etc.
            {
            ~\\
            \usecodefont
    ...
    \subsubsection{Examples:}\\
            \begin{code}[h!]
            \mysmallfont{}
                    symbol}\verb'First_symb'}\verb'   'directive}\verb'AUTOSPR'}\verb'   '
                    comment}\verb'; Automaticaly assigned, register at adress 0x00'}\\
                    symbol}\verb'Second_symb'}\verb'   'directive}\verb'AUTOSPR'}\verb'   '
                    \verb'  \verb'; Adress incremented, register at adress 0x01 '}\\
                    symbol}\verb'Third_symb'}\verb'   'directive}\verb'AUTOSPR'}\verb'   '
                    \verb'  \verb'; Adress incremented, register at adress 0x02 '}\\
                    comment}\verb'; Now with optional parameter changing counting adress '}\\
                    symbol}\verb'Fourth_symb'}\verb'   'directive}\verb'AUTOSPR'}\verb'   '
                    symbol}\verb'10h'}\verb'  \verb'; Registers are now defined from adress 0x10 '}
                    symbol}\verb'Fifth_symb'}\verb'   'directive}\verb'AUTOSPR'}\verb'   '
                    comment}\verb'; Now register at adress 0x11'}\\
    ...
    \subsubsection{Examples:}\\
        ...
        \subsubsection{Examples:}\\
                \begin{code}[h!]
                        \verb'    'directive}\verb'ORG'}\verb'   'constant}\verb'0x3FF'}\verb'                  \verb'; Number'}\\
                        \verb'    'directive}\verb'ORG'}\verb'   'label}\verb'START:'}\verb'                    \verb'; Symbol'}\\
                        \verb'    'directive}\verb'ORG'}\verb'   'label}\verb'INTERRUPT'}\verb'                 \verb'; Symbol'}\\
                        \verb'    'directive}\verb'ORG'}\verb'   'constant}\verb'($ + 15) AND 0xFFEE'}\verb'    \verb'; }\\
                \caption{Using ORG directive}
                \end{code}
                \begin{code}[h!]
                        \verb'    'directive}\verb'ADDRESS'}\verb'   'constant}\verb'0x3FF'}\verb'                  \verb'; Number'}\\
                        \verb'    'directive}\verb'ADDRESS'}\verb'   'label}\verb'START:'}\verb'                    \verb'; Symbol'}\\
                        \verb'    'directive}\verb'ADDRESS'}\verb'   'label}\verb'INTERRUPT'}\verb'                 \verb'; Symbol'}\\
                        \verb'    'directive}\verb'ADDRESS'}\verb'   'constant}\verb'($ + 15) AND 0xFFEE'}\verb'    \verb'; }\\
        ...
        \subsubsection{Examples:}\\
                        \begin{code}[h!]
                            symbol}\verb'A'}\verb'   'directive}\verb'EQU'}\verb' '
                            \verb'10'}\verb'       \verb'; First symbol'}\\
                            symbol}\verb'B'}\verb'   'directive}\verb'SET'}\verb' '
                            \verb'5'}\verb'       \verb'; Second  symbol, redefinable'}\\
                            symbol}\verb'C'}\verb'    'directive}\verb'DEFINE'}\verb' '
                            constant}\verb'(A + B) * 2'}\verb'   \verb'; Defined expresion'}\\
                            symbol}\verb'C = '}constant}\verb'30'}\\
                            symbol}\verb'B'}\verb'   'directive}\verb'SET'}\verb' '
                            \verb'10'}\verb'       \verb'; B redefined'}\\
                            symbol}\verb'C = '}constant}\verb'40'}\verb'   \verb'; C is now different'}\\\\
        ...
        \subsubsection{Examples:}\\
            \begin{code}[h!]
                comment}\verb'; With REPT'}\\\\
                directive}\verb'REPT'}\verb'    'constant}\verb'8'}\verb'   '
                comment}\verb'; Number of repetions'}\\
                instruction}\verb'SR0'}\verb'    'symbol}\verb'sF'}\\
                directive}\verb'ENDR'}\\
                comment}\verb'; Without REPT'}\\\\
                instruction}\verb'SR0'}\verb'    'symbol}\verb'sF'}\\
                instruction}\verb'SR0'}\verb'    'symbol}\verb'sF'}\\
                instruction}\verb'SR0'}\verb'    'symbol}\verb'sF'}\\
                instruction}\verb'SR0'}\verb'    'symbol}\verb'sF'}\\
        ...
        \subsubsection{Examples:}\\
                \begin{code}[h!]
                    symbol}\verb'my_symbol'}\verb'    '
                    directive}\verb'SET'}\verb'    'constant}\verb'15'}\\
                    comment}\verb` ; my_symbol declared, can be used`}\\
                    instruction}\verb'LOAD'}\verb'    'symbol}\verb'sF,my_symbol'}\\
                    directive}\verb'UNDEFINE'}\verb'    '
                    symbol}\verb'my_symbol'}\\
                    comment}\verb' ; my_symbol undeclared, cannot be used'}\\
                    instruction}\verb'LOAD'}\verb'    'symbol}\verb'sF,my_symbol'}
                    comment}\verb'; this will cause an error now'}
