...
\subsection{LED panel simulator}
    \begin{wrapfigure}{r}{0pt}
        \centering{}
        \includegraphics[width=110pt]{img/Led_panel.png}
        \caption{8-segment editor}
    \end{wrapfigure}
...
\subsection{7-segment simulator}
    ...
    \end{wrapfigure}
    You can simulate 7-segment display connected to output port(common anode). You can assign PORT bits to any display segment.
