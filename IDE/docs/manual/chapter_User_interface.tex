...
\subsection{Top panel}
   ...
   \begin{figure}[h!]
    ...
    \begin{table}[h!]
        \begin{tabular}{cc}
            \includegraphics[width=.25\textwidth]{img/file.png}
                &
            \includegraphics[width=.25\textwidth]{img/edit.png}
                \\
            File & Edit
        \end{tabular}
    \end{table}
    ...
    \begin{table}[h!]
        \begin{tabular}{cc}
            \includegraphics[width=.25\textwidth]{img/project_tab.png}
                &
            \includegraphics[width=.25\textwidth]{img/simulation.png}
                \\
            Project & Simulation
        \end{tabular}
    \end{table}
