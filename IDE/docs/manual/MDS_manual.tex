...
\chapter{User interface}        
         ...
         \section{Other tools}
                ...
                \subsection{DATA file convertor}
                    ...
                    \begin{description}
                        \item[Section Input File] Here you can choose which file you want to convert
                        ...
                        \item[Bytes per record] Only if you want to convert XilMem file. 
                        ...
                        \item[Section Output File]
                        \item[Section Output Options]
                ...
                \subsection{ASM translator}
                    ...
                    You can sellect one of three choices - Xilinx, Mediatronix and OpenPicIde.
