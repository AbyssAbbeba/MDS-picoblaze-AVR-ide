...
% }%		
        ...
        Those directives are CONSTANT, VARIABLE, ADRESS and NAMEREG. There are some other usefull directives like REPT or WHILE. See description below.
                ...
                \textbf{SYNTAX:}\\
                        ...
                        \\
                \textbf{DESCRIPTION:}\\
                The directive EQU stands for "equals"; it allows you to give a numerical value to a label. This symbol cannot be redefined.
                \\
                \textbf{EXAMPLE:}\\
            ...
            {\color{highlight_symbol}\verb'Second_symb'} with 0x2F and {\color{highlight_symbol}\verb'Third_symb'} with 0x39.
                ...
                \textbf{SYNTAX:}\\
                    ...
                    \\
                \textbf{DESCRIPTION:}\\
                The directive CONSTANT allows you to give a numerical value to a label. It is same like EQU, but with diferent syntax. Cannot be redefined.\\
