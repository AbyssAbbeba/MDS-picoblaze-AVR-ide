...
inst_input:
    ...
    | I_INPUT "@" expr "," expr     { $$ = new CompilerStatement(LOC(@$),ASMKCPSM3_INS_INPUT_SX_SY,$3->appendLink($5));}
...
/*     | I_OUTPUT "@" expr "," expr    { $$=new CompilerStatement(LOC(@$),ASMKCPSM3_INS_OUTPUT_SX_SY,$3->appendLink($5)); } */
