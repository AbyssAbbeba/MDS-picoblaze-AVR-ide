...
%{
    ...
    #include "AsmAvr8Lexer.h"

    // Name of the lexer function required by Bison
    #define AsmAvr8Parser_lex AsmAvr8Lexer_lex
    ...
    inline int AsmAvr8Parser_error ( YYLTYPE * yylloc,
                                  yyscan_t yyscanner,
