 ...
 * @file AsmPicoBlazeInstructionSet2.cxx
 */
// =============================================================================
...
unsigned int AsmPicoBlazeInstructionSet2::getAAA ( const CompilerStatement * stmt,
                                                   int index ) const
{
...
unsigned int AsmPicoBlazeInstructionSet2::getSXY ( const CompilerStatement * stmt,
                                                   int index ) const
{
...
unsigned int AsmPicoBlazeInstructionSet2::getKK ( const CompilerStatement * stmt,
                                                  int index ) const
{
    return m_symbolTable->resolveExpr(stmt->args()->at(index), OBS_KK);
}

unsigned int AsmPicoBlazeInstructionSet2::getPP ( const CompilerStatement * stmt,
                                                  int index ) const
{
    return m_symbolTable->resolveExpr(stmt->args()->at(index), OBS_PP);
}

int AsmPicoBlazeInstructionSet2::resolveOPcode ( const CompilerStatement * stmt ) const
{
    ...
    switch ( (int) stmt->type() )
    {
        ...
        case ASMPICOBLAZE_INS_CALL_AAA:
            return ( 0b110110000000000000 | getAAA(stmt, 0) );
        case ASMPICOBLAZE_INS_CALL_Z_AAA:
            return ( 0b110111000000000000 | getAAA(stmt, 0) );
        case ASMPICOBLAZE_INS_CALL_NZ_AAA:
            return ( 0b110111010000000000 | getAAA(stmt, 0) );
        case ASMPICOBLAZE_INS_CALL_C_AAA:
            return ( 0b110111100000000000 | getAAA(stmt, 0) );
        case ASMPICOBLAZE_INS_CALL_NC_AAA:
            return ( 0b110111110000000000 | getAAA(stmt, 0) );

        /* Instruction: RETURN */
        case ASMPICOBLAZE_INS_RETURN:
            return 0b100100000000000000;
        case ASMPICOBLAZE_INS_RETURN_Z:
            return 0b100101000000000000;
        case ASMPICOBLAZE_INS_RETURN_NZ:
            return 0b100101010000000000;
        case ASMPICOBLAZE_INS_RETURN_C:
            return 0b100101100000000000;
        case ASMPICOBLAZE_INS_RETURN_NC:
            return 0b100101110000000000;

        /* Instruction: RETURNI ENABLE/DISABLE */
        case ASMPICOBLAZE_INS_RETURNI_ENA:
            return 0b101100000000000001;
        ...
        case ASMPICOBLAZE_INS_LOAD_SX_SY:
            return ( 0b010000000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | ( getSXY(stmt, 1) << 3 ) );

        /* Instruction: AND */
        case ASMPICOBLAZE_INS_AND_SX_KK:
            return ( 0b000010000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | getKK(stmt, 1) );
        ...
        case ASMPICOBLAZE_INS_XOR_SX_SY:
            return ( 0b010110000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | ( getSXY(stmt, 1) << 3 ) );

        /* Instruction: ADD */
        case ASMPICOBLAZE_INS_ADD_SX_KK:
            return ( 0b001000000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | getKK(stmt, 1) );
        ...
        case ASMPICOBLAZE_INS_SR0_SX:
            return ( 0b101000000000001110 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SR1_SX:
            return ( 0b101000000000001111 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SRX_SX:
            return ( 0b101000000000001010 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SRA_SX:
            return ( 0b101000000000001000 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_RR_SX:
            return ( 0b101000000000001100 | ( getSXY(stmt, 0) << 8 ) );

        /* Instruction: SL0, SL1, SLX, SLA, RL */
        case ASMPICOBLAZE_INS_SL0_SX:
            return ( 0b101000000000000110 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SL1_SX:
            return ( 0b101000000000000111 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SLX_SX:
            return ( 0b101000000000000100 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_SLA_SX:
            return ( 0b101000000000000000 | ( getSXY(stmt, 0) << 8 ) );
        case ASMPICOBLAZE_INS_RL_SX:
            return ( 0b101000000000000010 | ( getSXY(stmt, 0) << 8 ) );
        ...
        case ASMPICOBLAZE_INS_INPUT_SX_SY:
            return ( 0b110001000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | ( getSXY(stmt, 1) << 3 ) );

        /* Instruction: OUTPUT */
        case ASMPICOBLAZE_INS_OUTPUT_SX_PP:
            return ( 0b100010000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | getPP(stmt, 1) );
        case ASMPICOBLAZE_INS_OUTPUT_SX_SY:
            return ( 0b110010000000000000
                     | ( getSXY(stmt, 0) << 8 )
                     | ( getSXY(stmt, 1) << 3 ) );
