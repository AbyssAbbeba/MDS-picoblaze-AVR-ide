...
{
    // TODO: Optimize this to search in an std::set
    for ( const AdjSimProcDef::Instruction & inst : m_device->m_instructionSet )
    {
...
inline AsmAdaptableTreeDecoder::CourseOfAction
       AsmAdaptableTreeDecoder::instruction2db ( CompilerStatement * node )
{
...
inline void AsmAdaptableTreeDecoder::dir_DB ( CompilerStatement * node )
{
