...
int (PIC8InstructionSet:: * const PIC8InstructionSet::m_opCodeDispatchTable[64])(const unsigned int opCode) = {
	...
	&PIC8InstructionSet::MOVLW,		// opCode = 11 0000 xxxx xxxx
	&PIC8InstructionSet::MOVLW,		// opCode = 11 0001 xxxx xxxx
	&PIC8InstructionSet::MOVLW,		// opCode = 11 0010 xxxx xxxx
	&PIC8InstructionSet::MOVLW,		// opCode = 11 0011 xxxx xxxx
	&PIC8InstructionSet::RETLW,		// opCode = 11 0100 xxxx xxxx
	&PIC8InstructionSet::RETLW,		// opCode = 11 0101 xxxx xxxx
	&PIC8InstructionSet::RETLW,		// opCode = 11 0110 xxxx xxxx
	&PIC8InstructionSet::RETLW,		// opCode = 11 0111 xxxx xxxx
	&PIC8InstructionSet::IORLW,		// opCode = 11 1000 xxxx xxxx
	&PIC8InstructionSet::ANDLW,		// opCode = 11 1001 xxxx xxxx
	&PIC8InstructionSet::XORLW,		// opCode = 11 1010 xxxx xxxx
	&PIC8InstructionSet::SUBLW,		// opCode = 11 1011 xxxx xxxx
	&PIC8InstructionSet::SUBLW,		// opCode = 11 1100 xxxx xxxx
	&PIC8InstructionSet::ADDLW,		// opCode = 11 1101 xxxx xxxx
	&PIC8InstructionSet::ADDLW,		// opCode = 11 1111 xxxx xxxx
};
...
int PIC8InstructionSet::instOPCode_000000(const unsigned int opCode) {
	...
	if ( !(opCode & 0x080) ) {
		...
		if ( opCode & 0x040 ) {
			...
			// opCode = 00 0000 0000 xxxx
			if ( 11 == opCode ) {
				// opCode = 00 0000 0000 1001
				return instRETFIE(opCode);
			} else if ( 10 == opCode ) {
				// opCode = 00 0000 0000 1000
				return instRETURN(opCode);
			} else if ( 0 == opCode) {
				// opCode = 00 0000 0xx0 0000
				return instNOP(opCode)
			} else {
				return instInvalid(opCode)
			}
		}
 ...
 * Operation: STACK ← Rd
 *
int PIC8InstructionSet::inst_PUSH_Rr(const unsigned int opCode) {
...
inline void AVR8InstructionSet::instMul(const unsigned int addrRd, const unsigned int addrRr) {
	// Registers
