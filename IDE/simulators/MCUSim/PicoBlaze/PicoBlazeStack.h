...
inline void PicoBlazeStack::pushOnStack ( unsigned int value )
{
    ...
    {
        logEvent(EVENT_STACK_OVERFLOW, m_position, value, MCUSimEventLogger::FLAG_HI_PRIO);
        m_position = 0;
    }
...
inline unsigned int PicoBlazeStack::popFromStack()
{
    ...
    if ( -1 == m_position )
    {
        logEvent(EVENT_STACK_UNDERFLOW, m_position, -1, MCUSimEventLogger::FLAG_HI_PRIO);
