...
inline float AVR8ClockControl::freqHighFreqCrystal ( const unsigned int clksel )
{
    ...
    if ( false == (*m_fusesAndLocks)[AVR8FusesAndLocks::FUSE_CKOPT] )
    {
        ...
        if ( ( m_clockSource.getFrequency() < freqRange[0] )
                 ||
    ...
    {
        if ( ( m_clockSource.getCapacity() < 12e-12 )
                 ||
...
inline unsigned int AVR8ClockControl::getClksel() const
{
    ...
    return ( ( ( true == (*m_fusesAndLocks)[AVR8FusesAndLocks::FUSE_CKSEL3] ) ? 0 : 0x8 ) |
...
{
    return ( ( ( true == (*m_fusesAndLocks)[AVR8FusesAndLocks::FUSE_SUT1] ) ? 0 : 0x2 ) |
...
inline AVR8ClockControl::StartUpTime AVR8ClockControl::startUpHighFreqCrystal ( const unsigned int clksel,
