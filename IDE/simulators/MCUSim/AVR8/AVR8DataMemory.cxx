...
MCUSim::RetCode AVR8DataMemory::directRead ( unsigned int addr,
...
MCUSim::RetCode AVR8DataMemory::directWrite ( unsigned int addr,
                                              unsigned int data )
{
    unsigned int addrVariant = (addr >> 24);
    addr &= ((1 << 24) - 1);
...
inline void AVR8DataMemory::loadConfig()
{
    ...
    for ( unsigned int i = 0, addr = 32;
          i < m_config.m_ioRegSize;
          i++, addr++ )
    {
