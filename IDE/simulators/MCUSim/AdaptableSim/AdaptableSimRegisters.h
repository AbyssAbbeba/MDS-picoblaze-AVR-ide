 ...
 */
class AdaptableSimRegisters : public MCUSimMemory
{
    ////    Public Datatypes    ////
    public:
        /**
    ...
    public:
         ...
         * @return
         */
        AdaptableSimRegisters * link ( MCUSimEventLogger * eventLogger );
...
inline unsigned int AdaptableSimRegisters::getUndefVal() const
{
...
inline unsigned int AdaptableSimRegisters::read ( unsigned int addr )
{
    if ( true == m_config.m_banks )
    {
        addr += ( m_bank * ( m_size / 2 ) );
