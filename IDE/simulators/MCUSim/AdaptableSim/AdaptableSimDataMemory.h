 ...
 */
class AdaptableSimDataMemory : public MCUSimMemory
{
    ////    Public Datatypes    ////
    public:
        /**
    ...
    public:
         ...
         * @return
         */
        AdaptableSimDataMemory * link ( MCUSimEventLogger * eventLogger );
...
inline unsigned int AdaptableSimDataMemory::getUndefVal() const
{
...
inline unsigned int AdaptableSimDataMemory::read ( unsigned int addr )
{
    if ( addr >= m_size )
    {
        if ( 0 == m_size )
