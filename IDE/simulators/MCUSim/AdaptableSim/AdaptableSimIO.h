 ...
 */
class AdaptableSimIO : public MCUSimPureLogicIO
{
    ...
    public:
         ...
         * @return
         */
        AdaptableSimIO * link ( MCUSimEventLogger * eventLogger );
...
inline unsigned int AdaptableSimIO::input ( unsigned int portID )
{
...
inline void AdaptableSimIO::output ( unsigned int portID,
                                  unsigned int value )
{
...
inline void AdaptableSimIO::clockCycle()
{
