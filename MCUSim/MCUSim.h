...
// 		int m_eventId;
// 		int m_eventDetail;
// 		LogEntry(int subsystemId, int eventId, int eventDetail) : m_subsysId(subsystemId), m_eventId(eventId), m_eventDetail(eventDetail) {};
// 		LogEntry() : m_subsysId(0), m_eventId(0), m_eventDetail(0) {};
// 	};
// // 	typedef std::vector<LogEntry> EventLogger;
...
// 			ID_IO
	...
	protected:
		...
		void logEventFast(int eventId, int eventLocation = 0, int eventDetail = 0)
		{
