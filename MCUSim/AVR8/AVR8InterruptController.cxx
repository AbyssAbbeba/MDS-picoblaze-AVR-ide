...
inline bool AVR8InterruptController::confirmInterrupt(AVR8InterruptController::InterruptVector vector) {
	...
	switch ( vector ) {
		case INTVEC_INT0:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::GICR, AVR8RegNames::GICR_INT0) )
					&&
		...
		case INTVEC_INT1:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::GICR, AVR8RegNames::GICR_INT1) )
					&&
		...
		case INTVEC_TIMER2_COMP:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_OCIE2) )
					&&
		...
		case INTVEC_TIMER2_OVF:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_TOIE2) )
					&&
		...
		case INTVEC_TIMER1_CAPT:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_TICIE1) )
					&&
		...
		case INTVEC_TIMER1_COMPA:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_OCIE1A) )
					&&
		...
		case INTVEC_TIMER1_COMPB:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_OCIE1B) )
					&&
		...
		case INTVEC_TIMER1_OVF:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TIMSK, AVR8RegNames::TIMSK_TOIE1) )
					&&
		...
		case INTVEC_USART_RXC:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::UCSRB, AVR8RegNames::UCSRB_RXCIE) )
					&&
		...
		case INTVEC_USART_UDRE:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::UCSRB, AVR8RegNames::UCSRB_UDRIE) )
					&&
		...
		case INTVEC_USART_TXC:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::UCSRB, AVR8RegNames::UCSRB_TXCIE) )
					&&
		...
		case INTVEC_ADC:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::ADCSRA, AVR8RegNames::ADCSRA_ADIE) )
					&&
		...
		case INTVEC_ANA_COMP:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::ACSR, AVR8RegNames::ACSR_ACIE) )
					&&
		...
		case INTVEC_TWI:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::TWCR, AVR8RegNames::TWCR_TWIE) )
					&&
		...
		case INTVEC_SPM_RDY:
			return (
				( true == m_dataMemory->readBitFast(AVR8RegNames::SPMCR, AVR8RegNames::SPMCR_SPMIE) )
					&&
